	...
	default:
		...
		case '/': // Prefix: "/"
			...
			case 'a': // Prefix: "authorize"
				...
				switch elem[0] {
				case '/': // Prefix: "/relation"

					if l := len("/relation"); len(elem) >= l && elem[0:l] == "/relation" {
						elem = elem[l:]
					} else {
						break
					}
					...
					if len(elem) == 0 {
						...
						switch r.Method {
						case "POST":
							s.handleCheckRelationRequest([0]string{}, elemIsEscaped, w, r)
						default:
							s.notAllowed(w, r, notAllowedParams{
								allowedMethods: "POST",
			...
			case 'a': // Prefix: "authorize"
				...
				case '/': // Prefix: "/relation"
					...
					if len(elem) == 0 {
						...
						switch method {
						case "POST":
							r.name = CheckRelationOperation
							r.summary = ""
							r.operationID = "checkRelation"
							r.operationGroup = ""
							r.pathPattern = "/authorize/relation"
							r.args = args
							r.count = 0
							return r, true
						default:
