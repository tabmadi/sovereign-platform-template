...
| A second GitOps repository | promotion commits outnumber code commits on `master`, or a review is opened against a diff more than half values bumps | **query** over merge history | [ADR-0201](../adr/0201-gitops.md) |
